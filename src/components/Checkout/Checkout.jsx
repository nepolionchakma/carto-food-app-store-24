...
const Checkout = () => {
    ...
    return (
        <div className='max-w-6xl mx-auto p-5 my-4'>
            <h3 className='text-center font-bold text-3xl p-3 my-4'>Billing Details</h3>
                ...
                <div>
                    <div className='grid grid-cols-2 gap-4 justify-around'>
                        ...
                        <div className="flex flex-col gap-1">
                            {
                                carts.map((item, i) => (
                                    <div key={i} className='flex justify-between gap-3 my-2 p-2 '>
                    ...
                    <button className=" my-3 rounded-xl border-[1px] border-black px-4 py-2 ">Place Order</button>
                </div>
            </div>
        </div>
    );
